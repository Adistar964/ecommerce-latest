...
urlpatterns = [
    ...
    path("getFilterOptions/", views.getFilterValues), # this one returns the data needed to show in filter-options-screen
    
    # this one gets homepage content like the carousel-images and also the featured products
    ...
    path("fetchAllProductTypes/<str:category>/", views.fetchAllProductTypes), # fetches all the product-types corresponding to a category
