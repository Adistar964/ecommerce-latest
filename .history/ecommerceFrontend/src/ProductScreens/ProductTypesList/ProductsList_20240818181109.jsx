...
// The interface here is similar to searchPage
...
const search_text = "everything" //empty as we dont want anything specific
...
function ProductsFromProductType() {
    ...
    function applyFilters(){
        ...
        const body = { filters:{ category:category,type:productType, ...filt } }
                                    ...
                                    <Accordion>
                                        ...
                                        <Accordion.Item eventKey="1">
                                            ...
                                            <Accordion.Body>
                                                <input type="checkbox"
                                                id="allCategories"
                                                defaultChecked={selectedCategories.length==categoriesList.length} // mark it as checked, if user selected everything from the categories-list
                                                onClick={inp => {
                                                    if(inp.target.checked){ // if someone checked it, then check all the categories from the categoriesList
                                                        document.querySelectorAll("input[name='categoryFilter']").forEach(inp => inp.checked=true)
                                                    }else{ // otherwise, un-check all brands
                                                        document.querySelectorAll("input[name='categoryFilter']").forEach(inp => inp.checked=false)
                                                    }
                                                }}
                                                />
