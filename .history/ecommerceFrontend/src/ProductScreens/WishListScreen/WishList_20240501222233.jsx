                            ...
                            className="w-100 border d-flex p-3 align-items-center cart-item-hover">
                                ...
                                <div className="p-3 ml-3">
                                    ...
                                    <select onChange={e=>{
                                        ...
                                        const price = document.getElementById("wish-price"+idx)
                                        console.log(Number(price) * Number(target.value))
                                ...
                                <div className="ml-3 mr-3">
                                    <p>QAR <b id={"wish-price"+idx}>{(item.price-item.discountPrice)}</b></p>
                                </div>
