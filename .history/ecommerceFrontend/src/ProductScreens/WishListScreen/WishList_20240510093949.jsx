                ...
                <HeaderAndFooter>
                    <div className="p-3 text-center container border border-secondary">
                        ...
                        <ul style={{listStyle:"none"}}>
                            <div className="w-100 border border-dark d-flex justify-content-start align-items-center p-3">
                                <input type="checkbox" style={{transform:"scale(1.8)"}} />
                                
                                <p className="align-self-center">&nbsp;&nbsp;&nbsp; Select All</p>
                            </div>
