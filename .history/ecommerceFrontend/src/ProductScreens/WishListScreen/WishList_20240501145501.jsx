...
export default function WishList(props){
    ...
    const addSelectedToCart = async () =>  {
        ...
        for(let item of context["favourites"]){
            if(document.getElementById("wishlist-check-"+idx).checked){
                const item_quantity = document.getElementById("wishlist-select-"+idx).value // will give us selected quantity
        ...
        for(let wishlist_item of selected_items){
            ...
            if(!exists_in_cart){
                const product = {...wishlist_item,quantity:wishlist_item["quantity"]} // in the right document format
        ...
        const body = {
            ...
            update_query:{$set:{cart_items:cart_items}} // mongodb query
        }
