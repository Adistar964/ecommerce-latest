        ...
        if(notFound===false && context["user"] !== null){
            ...
            for(let fav of [...context["favourites"]]){
                if(fav.product_id === product.product_id){
                    console.log("here inside true if")
                    exists_in_favourites = true
                }
            }
            // we will now basically toggle
            if(exists_in_favourites){setIsFavourite(false)}
            else if(!exists_in_favourites){setIsFavourite(true)}            
        }
