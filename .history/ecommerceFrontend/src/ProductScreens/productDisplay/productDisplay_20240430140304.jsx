...
export default function ProductDisplay(props){
    ...
    useEffect(() => {
        ...
        if(notFound===false && context["user"] !== null){
            // console.log("favourites is",context["favourites"])
            for(let fav in [...context["favourites"]]){
                console.log(product.product_id,fav.product_id)
                if(fav.product_id === product.product_id){
                    console.log("here inside true if")
                    setIsFavourite(true); // otherwise it will remain false(default value)
                }
            }            
        }
