...
const addProductToRecentlyVisited = product => {
    ...
    recently_visited_prodsArray = localStorage.getItem("recentlyVisited")
    // if there is no recently-visited array in localStorage, then:
    if(recently_visited_prodsArray === null){
    ...
    // if our recentlyVisited array exists:
        ...
        localStorage.setItem("recentlyVisited",JSON.parse(visited_prods))
    }
}