...
function CheckOutButton(){
    ...
    const makePayment = async () => {
        ...
        const response = await fetch(backend_link+"/makePayment/",requestParams)
        const response_data = await response.json()
        window.location.href = response_data["url"] // we will redirect where the backend sends us
        setLoading(false)
    }
