...
import { changeQuantity, clearCart } from "./CartFunctions";
...
export default function CartScreen(){
    ...
    if(context["loading"]){
        ...
        return (
            <HeaderAndFooter>
                <div className="p-3 text-center container border border-secondary shadow-lg">
                    <div className="d-flex">
                        <h3 style={{fontFamily:"arial",flexGrow:1}}>
                            YOUR CART
                        </h3>
                        <a href="" 
                    ...
                    <div className="text-center">
                        <button onClick={()=>navigate("/makePayment/cart_purchase")}
        ...
        return(
            <HeaderAndFooter>
                <div className="text-center p-4 container border border-black shadow-lg">
                    <BsBagDashFill  color="rgb(245, 55, 55)" size="10em" className="d-block m-auto mb-4" />
                    <h3>
                        <i>
                    ...
                    <p className="text-muted">
                        Looks like you have not added anything into your cart.
                        <br />
                        Go Ahead and explore the rpoducts
                    </p>
