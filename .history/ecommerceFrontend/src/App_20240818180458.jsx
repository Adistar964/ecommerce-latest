...
import ProductTypesScreen from "./ProductScreens/ProductTypesList/ProductTypes.jsx";
import './index.css'
import ProductsFromProductType from "./ProductScreens/ProductTypesList/ProductsList.jsx";
...
const ecommerce_router = createBrowserRouter(
  [
    ...
    {path:"/ProductTypes/:category", element: <ProductTypesScreen />}, // for viewing all product-types corresponding to a category
    {path:"/products/:category/:productType", element: <ProductsFromProductType />}, // for viewing products of this type coming under this category
  ]
);
