...
export default function SignUp(){
    ...
    function createAccount(){
        ...
        if (password === retypePassword){
            ...
            .then(credentials => {alert("User created with email:",email);navigate("/login/",alertmsg="login!!")})
            .catch(error=>{
            ...
            navigate("/login/",{props:{alertmsg:"login!!"}})
            alert("The passwords dont match!"+email)
        }
    }
