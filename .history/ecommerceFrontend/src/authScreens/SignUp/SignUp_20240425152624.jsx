        ...
        if (password === retypePassword){
            ...
            .catch(error=>{
                if (error.message==="Firebase: Error (auth/email-already-in-use)."){
                    setLoading(false)
                    context.setAlertTitle("Welcome!")
                    context.setAlertBody(`User created with email-address: "${email}" \n Now please login!`)
                    context.setAlertBtnText("Register")
                    context.alertBtnAction.current = ()=>{} // we did .current as it is useRef
