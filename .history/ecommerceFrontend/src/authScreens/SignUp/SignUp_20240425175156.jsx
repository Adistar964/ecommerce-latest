...
import { createUserWithEmailAndPassword, 
        OAuthProvider, signInWithRedirect  } from "firebase/auth";
...
export default function SignUp(){
    ...
    const createAccountWithGoogle = () => {
        const GoogleProvider = new OAuthProvider("www.google.com");
        signInWithRedirect(auth,GoogleProvider).catch(err=>console.log(err))
    }
