...
function SearchPage() {
    ...
    function applyFilters(){
        ...
        document.getElementsByName("brandFilter").forEach( brand => brand.checked??userSelectedbrnds.push(brand.value) );
        ...
        document.getElementsByName("categoryFilter").forEach( category => category.checked??userSelectedCats.push(category.value) );
        ...
        console.log(userSelectedCats);
        console.log(userSelectedbrnds);
                            ...
                            <Modal.Body>
                                <div className="text-center">
                                    ...
                                    <div className="form-group">
                                        ...
                                        value={minPrice} min={1} onChange={inp => setMinPrice(inp.target.value)} />
                                    </div>
                                    <div className="form-group mb-2">
                                        <label htmlFor="maxPriceSrch" className="form-label">Maximum Price &nbsp;</label>
                                        <input type="number" className="form-contorl text-center"
                                         id="maxPriceSrch" required 
                                         value={maxPrice} min={1} onChange={inp => setMaxPrice(inp.target.value)} />
                                    </div>
                                    <h4>Brands &nbsp;</h4>
