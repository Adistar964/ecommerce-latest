...
function SearchPage() {
    ...
    const [selectedMinPrice,setSelectedMinPrice] = useState(0) // by default, the selected minimum price is 0
    const [selectedMaxPrice,setSelectedMaxPrice] = useState(0) // by default, the selected maximum price is also 0 (but later we will change it to the actual max price from the search results)
    ...
    useEffect(()=>{
        const getProducts = async () => {
            ...
            try{
                ...
                // also set this:
                setSelectedMinPrice(1); // initial selected minPrice before user sets it to smth else
            }catch(e){
                console.log(e)
                throw Error("Error!")
            }
    ...
    function applyFilters(){
        ...
        const minimumPrice = document.getElementById("minPriceFilter").value
        const maximumPrice = document.getElementById("maxPriceFilter").value
        ...
        setSelectedMaxPrice(maximumPrice)
        setSelectedMinPrice(minimumPrice)
