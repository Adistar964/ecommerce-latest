                        ...
                        <Modal show={showFilters} onHide={()=>setShowFilters(false)}>
                            ...
                            <Modal.Body>
                                <form className="text-center">
                                    ...
                                    <div className="form-group">
                                        <label className="form-label display-6">Brands &nbsp;</label>
                                        {brands.map(brand => 
                                            <>
                                                <br />
                                                <input type="checkbox" value={brand} name="brandFilter" id={brand}/>
                                                <label htmlFor={brand}>{brand}</label>
                                            </>
                                        )}
                                    </div>
                                    <div className="form-group">
                                        <label className="form-label display-6">Category &nbsp;</label>
                                            {categories.map(category =>
                                                <>
                                                    <br />
                                                    <input type="checkbox" value={category} name="categoryFilter" id={category}/>
