...
function SearchPage() {
    ...
    function applyFilters(){
        ...
        document.getElementsByName("brandFilter").forEach(brand => {console.log(brand.checked);userSelectedbrnds.push(brand)});
        document.getElementsByName("categoryFilter").forEach(category => userSelectedbrnds.push(category))
    }
