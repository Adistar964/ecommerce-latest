                        ...
                        <Modal show={showFilters} onHide={()=>setShowFilters(false)}>
                            ...
                            <Modal.Body>
                                <div className="text-center">
                                    ...
                                    onClick={()=>setBrandsListOpen(!brandsListOpen)}> {/* onClick toggles the Collapse below */}
                                        <h4>
                                            Brands &nbsp;
                                            {brandsListOpen ? <IoIosArrowUp /> : <IoIosArrowDown />}
                                            {/* The above shows upArrow if list is open adn vice versa */}
                                        </h4>
                                    </button>
                                    <br />
                                    <Collapse appear={brandsListOpen}> {/*  "in" argument is basically can be taken as "isOpen" argument for understanding */}
                                        <div className="ss">
                                            {brands.map(brand =>
                                                <>
                                                    <input type="checkbox"
