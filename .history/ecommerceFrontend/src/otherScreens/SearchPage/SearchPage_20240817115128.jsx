                            ...
                            <Modal.Body>
                                <form className="text-center">
                                    ...
                                    <div className="form-group">
                                        ...
                                        {brands.map(brand => 
                                            <>
                                                <input className="mr-5" type="checkbox" value={brand} name="brandFilter" id={brand}/>
                                    ...
                                    <div className="form-group">
                                        <h4 className="mt-3">Category &nbsp;</h4>
                                            {categories.map(category =>
                                                <>
                                                    <input className="mr-5" type="checkbox" value={category} name="categoryFilter" id={category}/>
