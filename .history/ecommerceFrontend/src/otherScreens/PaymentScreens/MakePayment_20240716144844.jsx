...
export default function MakePayment(props){
    ...
    return (
        <HeaderAndFooter>
            ...
            {currentStepIndex === 0 ? 
                <DeliveryTimingSelection setCurrentStepIndex={setCurrentStepIndex} setDeliveryDate={setDeliveryDate} setSlot={setSlot} slot={slot} /> // basically setting delivery timing here
            : <CardPayment
