...
export default function MakePayment(props){
    ...
    return (
        <HeaderAndFooter>
            ...
            {currentStepIndex === 0 ? 
                <DeliveryTimingSelection setCurrentStepIndex={setCurrentStepIndex} setDeliveryTiming={setDeliveryTiming} setDeliveryDate={setDeliveryDate} deliveryDate={deliveryDate} /> // basically setting delivery timing here
            : <CardPayment
              setCurrentStepIndex={setCurrentStepIndex} // for going back to the delivery-slot-screen
              deliveryTiming={deliveryTiming}  // and then passing the selected timing to this screen so it can send it to backend
               />
            }
        </HeaderAndFooter>
    );
