...
export default function MakePayment(props){
    ...
    const [selectedSlot, setSelectedSlot] = useState({}) // this will be the Slot chosen by the user (for now, it is empty)
...
function DeliveryTimingSelection(props){
    ...
    return (
        <div className="shadow-lg border container p-3 mt-3 text-center">
            ...
            {allSlots.map(slot => 
                <div className="m-5 mt-0 mb-1 d-flex justify-content-around align-items-center border shadow-lg p-2">
                    <div className="flex-grow-1 d-flex">
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="radio"
                        className="chckbx-slot" // all slot-checkboxes will have this to identify them
            ...
            className="btn btn-theme d-flex justify-content-between w-25 align-content-center text-light">
                Next
                <FaArrowRight />
            </button>
        </div>
