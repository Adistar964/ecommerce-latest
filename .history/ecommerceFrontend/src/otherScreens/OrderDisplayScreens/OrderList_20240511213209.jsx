        ...
        <HeaderAndFooter>
            <div className="mt-3 mb-3 container shadow border border-3 border-top-0">
                ...
                <Tabs defaultActiveKey="pending" fill variant="pills" className="border border-2 rounded">
                    ...
                    <Tab className="p-3" eventKey="arriving" title="arriving orders"> {/* eventKey is used for switching tabs and title is what user sees as tab-title */}
                        <Orders orderItems={arrivingItems} emptyMessage="Nothing in here" />
                    </Tab>
