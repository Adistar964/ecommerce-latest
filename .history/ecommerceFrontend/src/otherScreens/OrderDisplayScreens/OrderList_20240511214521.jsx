...
export default function OrderList() {
    ...
    const [arrivingItems,setArrivingItems] = useState([]);
    ...
    useEffect(() => {
        ...
        const getOrdersFromDb = async () => {
            ...
            setArrivingItems(data["arriving_orders"])
        ...
        <HeaderAndFooter>
            <div className="mt-3 mb-3 container shadow border border-3 border-top-0">
                ...
                <Tabs defaultActiveKey="pending" fill variant="pills" className="border border-2 rounded">
                    <Tab className="p-3" eventKey="pending" title="open orders"> {/* eventKey is used for switching tabs and title is what user sees as tab-title */}
                        <Orders orderItems={[...arrivingItems,...pendingItems]} emptyMessage="Nothing in here" />
                    </Tab>
                    ...
                    <Tab className="p-3" eventKey="all" title="all orders">
                        <Orders orderItems={[...pendingItems,...deliveredItems,...cancelledItems,...arrivingItems]} emptyMessage="Nothing in here" />
                    </Tab>
                </Tabs>
            </div>
        </HeaderAndFooter>
