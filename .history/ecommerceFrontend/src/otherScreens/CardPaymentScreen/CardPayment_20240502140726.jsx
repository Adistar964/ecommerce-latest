...
export default function CardPayment(props){
    ...
    useEffect(() => {
        ...
        //payment options
        var paymentOptions = {
          currencyCode:["QAR"], //change the currency array as per your requirement
          labels : labels,
          TextDirection:'ltr', //only two values valid (rtl, ltr)
          paymentAllowed: ['VISA'] //default string 'all' to show all payment methods enabled on your account
        }
