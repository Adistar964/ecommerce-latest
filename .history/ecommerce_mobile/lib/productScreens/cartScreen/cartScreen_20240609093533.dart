          ...
          children : [
            ...
            OutlinedButton.icon(
              ...
              style: OutlinedButton.styleFrom(
                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(6), side: BorderSide(color: Colors.lightBlue)),
              ),
              label: const Text(
                "Continue Shopping",
        ...
        title: Row(
          ...
          children: [
            ...
            TextButton(
              onPressed: (){
                showDialog(context: context, builder: (context){
                    return AlertDialog(
                      ...
                      content: const Text("Do you want to proceed clearing your cart?\nIt can not be undone."),
                        ...
                        OutlinedButton.icon(
                          onPressed: () async {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(content: Text("Cart Cleared!", style: TextStyle(color: Colors.white)), backgroundColor: Colors.blue, showCloseIcon: true)
                            );
                          },
              ...
              child: const Text("Clear", style: TextStyle(fontSize: 16.5)),
            )
          ]
        ),
        backgroundColor: const Color.fromARGB(179, 207, 216, 220),
