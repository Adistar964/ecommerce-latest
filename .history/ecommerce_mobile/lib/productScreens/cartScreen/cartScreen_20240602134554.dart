                    ...
                    Row(
                      children: [
                        IconButton.outlined(
                          ...
                          onPressed: ()=>subtractQuantity(context,widget.product,()=>widget.updateTotalAmount()), // updating totalAmount after changing the quantity
                          color: Colors.blue,
                        ...
                        IconButton.outlined(
                          onPressed: ()=>addQuantity(context,widget.product,()=>widget.updateTotalAmount()), // updating totalAmount after changing the quantity
                          color: Colors.blue,
                          style: IconButton.styleFrom(
                            fixedSize: Size(10, 10),
                            side: BorderSide(color: Colors.blue)
  ...
  Widget build(BuildContext context) {
    return BottomAppBar(
      ...
      child: ElevatedButton(
        ...
        child: Text(
          "Checkout $currency ${widget.totalAmount}",
          style: TextStyle(
            fontSize: 18,
            fontWeight: FontWeight.bold
          ),
