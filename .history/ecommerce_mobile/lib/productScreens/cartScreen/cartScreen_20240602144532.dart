                      ...
                      Row(
                        children: [
                          IconButton.outlined(
                            ...
                            onPressed: ()=>subtractQuantity(context,product,()=>{}), // no callback as the provider updates here, hence empty function is passed
                            color: Colors.blue,
                          ...
                          IconButton.outlined(
                            onPressed: ()=>addQuantity(context,product,(){}), // no callback as the provider updates here, hence empty function is passed
                            color: Colors.blue,
                            style: IconButton.styleFrom(
                              fixedSize: Size(10, 10),
                              side: BorderSide(color: Colors.blue)
      ...
      child: ElevatedButton(
        ...
        child: Row(
          ...
          children: [
              ...
              Text(
                "$currency ${context.watch<MyProvider>().cartTotal}", // .watch is used so that it updates
                style: TextStyle(
                  fontSize: 18,
