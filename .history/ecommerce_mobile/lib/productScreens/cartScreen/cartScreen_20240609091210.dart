    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Row(
          ...
          children: [
            const Text("Your s", style: TextStyle(fontWeight: FontWeight.bold)),
            TextButton(onPressed: (){}, style: TextButton.styleFrom(backgroundColor: Colors.red),child: Text("Clear"))
          ]
        ),
        // centerTitle: true,
