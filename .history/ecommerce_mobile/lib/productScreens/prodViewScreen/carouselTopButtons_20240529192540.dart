...
class FavButton extends StatelessWidget {
  ...
  final dynamic checkFav;
  final dynamic isFav;
  const FavButton({super.key,this.product,this.checkFav,this.isFav});

  @override
  Widget build(BuildContext context) {
    return GestureDetector( // to add onTap event
      onTap: ()=>toggleFav(context, product, checkFav),
      child: Container(
