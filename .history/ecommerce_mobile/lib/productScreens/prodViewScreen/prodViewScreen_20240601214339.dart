...
class ProdViewScreen extends StatefulWidget {
  ...
  final dynamic homeScreen_CheckFav;
  final dynamic homeScreen_AssignCartQuantity;
  const ProdViewScreen({super.key,this.product,this.homeScreen_CheckFav,this.homeScreen_AssignCartQuantity});
...
class _ProdViewScreenState extends State<ProdViewScreen> {
  ...
  callAssignProductCartQuantity(){
    ...
    widget.homeScreen_AssignCartQuantity(); // to also update homeScreen
  }
  ...
  callCheckFav(){
      ...
      widget.homeScreen_CheckFav(); // to also update homeScreen
  }
  @override
      ...
      bottomNavigationBar: BottomAppBar( // we already have a bottomNavBar from the mainWrapper, but this one is a an appbar which shows cart buttons
        ...
        child: Container(
          ...
          child: ( productCartQuantity==0? // if the product id not there in the cart
              ElevatedButton.icon(
              onPressed: ()=>addToCart(context,product,callAssignProductCartQuantity),
            ...
            : Row( // otherwise show these buttons
              ...
              Expanded(
                child: MaterialButton(
                  onPressed: ()=>subtractQuantity(context, product, callAssignProductCartQuantity),
              ...
              Expanded(
                child: MaterialButton(
                  onPressed: ()=>addQuantity(context, product, callAssignProductCartQuantity),
                  padding: const EdgeInsets.all(12.6),
                  color : Colors.lightBlue,
                  textColor: Colors.white,
