...
class _ProdViewScreenState extends State<ProdViewScreen> {
  ...
  int quantityInCart = 0; // this shows the quantity of this item in the cart (zero implies that it is not there in the cart)
  ...
  // this function was made to reduce code while calling checkFav function so that we dont write these params over and over again
  callCheckFav(){
      checkFav(context,
          ...
          child: Column(
            ...
            children: [
                Container(
                  ...
                  child: ( quantityInCart==0? // if the product id not there in the cart
                      ElevatedButton.icon(
                      onPressed: (){},
