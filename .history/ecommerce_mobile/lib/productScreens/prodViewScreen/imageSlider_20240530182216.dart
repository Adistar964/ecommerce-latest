...
class CarouselIndicators extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AnimatedSmoothIndicator ( // from package "smooth_page_indicator"
      ...
      effect: const JumpingDotEffect( // params are not required, but we need to do some changes which is why we added some params
        dotColor: Colors.white,
        activeDotColor: Color.fromARGB(255, 33, 243, 79),
        dotHeight: 13,
        dotWidth: 13,
      ), 
      // look more in their webpage for different effects they have: ex: JumpingDotEffect,ExpandingDotsEffect,etc..
      );
  }
}