                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        (product["discountPrice"] != 0 ? // if there is a discountPrice, then show this below
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(
                                "$currency ${product["price"]}",
                                style: const TextStyle(fontSize: 18, decoration: TextDecoration.lineThrough,color: Color.fromARGB(255, 127, 125, 125)),
