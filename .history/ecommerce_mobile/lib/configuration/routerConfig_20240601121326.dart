      ...
      branches: [
        ...
        StatefulShellBranch(
          ...
          GoRoute(
            ...
            routes: [
              GoRoute(path: "productView", name:"productView",builder: (context, state) => ProdViewScreen(product: state.extra)) // the product data was passed in extra argument when calling .pushNamed 
            ]
          )
        ]),
