          ...
          GoRoute(
            ...
            routes: [
              GoRoute(path: "productView", name:"productView",builder: (context, state){
                ...
                // prodView screen uses this product argument to display that product
                // similarly these ones were also passed in extra-param in pushNamed to also keep homeScreen updated in the backgground
                dynamic homeScreen_AssignCartQuantity = arguments["homeScreen_AssignCartQuantity"];
                dynamic homeScreen_CheckFav = arguments["homeScreen_CheckFav"];
                return ProdViewScreen(
                  product: product,
                  homeScreen_AssignCartQuantity: homeScreen_AssignCartQuantity,
                  homeScreen_CheckFav: homeScreen_CheckFav
                );
              })
            ]
          )
