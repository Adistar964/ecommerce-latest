...
class _ProductCardState extends State<ProductCard> {
  ...
  @override
  void initState() {
    super.initState(); // parent initState must always run!
    ...
    if(context.mounted){ // first let everything get loaded (double check)
        //callAssignProductCartQuantity2() will check if the product is in the cart and assigns it a proper quantity if it exists, otherwise assigns product a quantity of 0
        callAssignProductCartQuantity2(); // this function simply calls assignCartQuantity function with appropriate parameters
        // callAssignProductCartQuantity2 is basically qssignCartQuantity function, but shortened code
  ...
  callAssignProductCartQuantity2(){
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: GestureDetector(
                          onTap: ()=>GoRouter.of(context).pushNamed("productView",extra: {"product":widget.product}).then((_)=>callAssignProductCartQuantity2()),// we r passing an argument here thru extra argument
                          ...
                          //   ).then( (_){callCheckFav();callAssignProductCartQuantity2();} ), 
...
// as we need to run checkFav and assignProductQuantity to reload changes in this page as some other page might have changed some values like cart or wishlist
                      ...
                      MaterialButton(
                        onPressed: ()=>addToCart(context, widget.product, callAssignProductCartQuantity2),
                    ...
                    : Row(
                      ...
                      Expanded(
                        child: MaterialButton(
                          onPressed: ()=>subtractQuantity(context, widget.product, callAssignProductCartQuantity2),
                          padding: const EdgeInsets.all(8),
                          color : Colors.lightBlue,
                          textColor: Colors.white,
                          // shape: RoundedRectangleBorder( borderRadius: BorderRadius.circular(10) ),
                      ...
                      Expanded(
                        child: MaterialButton(
                          onPressed: ()=>addQuantity(context, widget.product, callAssignProductCartQuantity2),
                          padding: const EdgeInsets.all(8),
                          color : Colors.lightBlue,
                          textColor: Colors.white,
                          // shape: RoundedRectangleBorder( borderRadius: BorderRadius.circular(10) ),
