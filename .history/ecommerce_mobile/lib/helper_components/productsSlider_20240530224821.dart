                      ...
                      Padding(
                        ...
                        child: GestureDetector(
                          onTap: () => Navigator.of(context).pushNamed(
                            ...
                            ).then( (_)=>setState((){}) ), // doing this would make sure that this screen run initState function again when u come back to this screen, as we need to run checkFav and assignProductQuantity to reload changes in this page
