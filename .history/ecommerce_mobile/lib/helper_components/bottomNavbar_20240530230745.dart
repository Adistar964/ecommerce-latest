      ...
      child: Padding(
        ...
        child: GNav( 
            ...
            tabs: [
              ...
              GButton(text:"Cart" , icon: Icons.shopping_cart_outlined, onPressed: ()=>Navigator.pushNamed(context, "/cartScreen")),
              GButton(text:"Wishlist" , icon: Icons.favorite_outline, onPressed: ()=>Navigator.pushNamed(context, "/signUpScreen")),
              GButton(text:"Profile" , icon: Icons.person_outline, onPressed: ()=>Navigator.pushNamed(context, "/loginScreen")),
            ],
        ),
      ),
    );
