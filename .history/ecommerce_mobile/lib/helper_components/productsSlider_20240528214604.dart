...
class _ProductCardState extends State<ProductCard> {
  ...
  subtractQuantity() async {
    try{
      ...
      int quantity = widget.product["quantity"]; // current quantity of our product
      dynamic newCart = [ ...context.read<MyProvider>().cart ]; // our current cart (we will make changes to it)
  ...
  addQuantity() async {
    try{
      int quantity = widget.product["quantity"]; // current quantity of our product
      int maxUserQuantity = widget.product["maxUserQuantity"]; // max quantity a user can add in the cart
      dynamic newCart = [ ...context.read<MyProvider>().cart ]; // our current cart (we will make changes to it)
