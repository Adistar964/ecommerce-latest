...
class _ProductCardState extends State<ProductCard> {
  ...
  void initState() {
    ...
    // this current initState is basically the parent initState function, but we have added some functionality of ours below
    WidgetsBinding.instance.addPostFrameCallback((_) { // first let everything get loaded
        if(context.mounted && context.read<MyProvider>().cart != null){ 
