                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: GestureDetector(
                          onTap: ()=>GoRouter.of(context).pushNamed("productView",extra: {"product":widget.product}).then((_)=>{callAssignProductCartQuantity();}),// we r passing an argument here thru extra argument
