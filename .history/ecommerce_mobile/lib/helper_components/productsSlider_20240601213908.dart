                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: GestureDetector(
                          onTap: ()=>GoRouter.of(context).pushNamed("productView",extra: {
                            "product":widget.product,
                             // below will be called in the prodView screen incase of any updates in cart/wishlst, so when user lands back to homepage, cart/wishlist things are updates
                            // example: cocacola is not in the cart. User goes to cocacola prodView screen and then adds it to cart, but when he lands back to homescreen, the homeScreen is not yet updated saying that cocacola is not in cart as before
                            // to prevent this, we call these call-functions from the prodView screen to update homescreen in the background
                            "homeScreen_AssignCartQuantity":callAssignProductCartQuantity,
                            "homeScreen_CheckFav":callCheckFav,
                            }),// we r passing an argument here thru extra argument
