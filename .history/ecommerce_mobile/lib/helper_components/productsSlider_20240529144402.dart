      ...
      child: ClipRRect(
        ...
        child: Stack(
          ...
          Positioned( // Positioned is for giving any position to elements inside it
            ...
            right: 0,
            child: 
              LikeButton( // from "like_button" package which gives cool animation for like button
                isLiked: isFav,  // to inform it when the button is liked
                size: 40, // button size
                onTap: (isLiked)=>toggleFav(context, widget.product, checkFav),
                likeBuilder:(isLiked)=> // likeBuilder is basically the widget this likeButton takes as child
                IconButton(
                  iconSize: 25,
                  ...
                  onPressed: (){},
                  icon: Icon(Icons.favorite_outline_rounded,color: isLiked ? Colors.red :Colors.grey)
                ),
              )
            ),
          ]
