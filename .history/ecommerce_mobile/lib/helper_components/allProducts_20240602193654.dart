...
class AllProducts extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: GridView.builder( // we will not use GridView.count, but GridView.builder, therefore it is a bit different
        // instead of simply giving crossAxisCount: numer_of_items, we have to do it like below:
        gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2,mainAxisExtent: 400),
