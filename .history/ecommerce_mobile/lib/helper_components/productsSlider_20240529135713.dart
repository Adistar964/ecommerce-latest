          ...
          Positioned( // Positioned is for giving any position to elements inside it
            ...
            child: GestureDetector(
              ...
              child: LikeButton( // from like_button package => it gives cool like animation
                ...
                circleColor: CircleColor(start: Colors.black, end: Colors.yellow),
                padding: const EdgeInsets.all(10),
                likeBuilder: (isLiked) => Icon(Icons.favorite_outline_rounded, size: 30,color: isLiked==true ? Colors.red :Colors.grey),
              ),
            ),
          )
          ]
