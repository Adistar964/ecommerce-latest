...
class SignUpScreen extends StatelessWidget {
  ...
  validateAndSignUp(context){
    ...
    if( !EmailValidator.validate(email) ){
        ...
        alert(context, "Register Error", "email is not valid!");
    }else if ( password.length < 8 ){
        alert(context, "Register Error", "Password must be atleast 8 charachters long!");
    }else if( password != retypePassword ){
        alert(context, "Register Error", "Password dont match!");
