...
class LoginScreen extends StatelessWidget {
  ...
  processLogin(context){
    ...
    var password = emailFieldController.text;
    if (EmailValidator.validate(email)){ // if user wrote a proper email address in the email-field
      ...
      showDialog( // show error!
          ...
          builder: (context){
              return AlertDialog(
                ...
                actions: [
                  Align(
                    alignment: Alignment.centerLeft, // aligning this button to the left
                    child: TextButton(
