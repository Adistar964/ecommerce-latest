      ...
      body: SafeArea(
        child: Center(
            child: Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.stretch, // this will make every widget in it stretch to 100% width in x-direction especially the button
                children: [
                    ...
                    const Text("please sign in to continue", style: TextStyle( fontSize: 19, color: Color.fromARGB(255, 89, 88, 88) ) ),
                  ...
                  const SizedBox(height: 40), // leaving some space
                  MaterialButton( // a very customizable button
                    onPressed: (){},
                    color: Colors.black,
