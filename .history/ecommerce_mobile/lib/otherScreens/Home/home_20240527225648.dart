...
class _HomeScreenState extends State<HomeScreen> {
  ...
  mainBody() {
      return Scaffold(
        ...
        // app body
        body: SafeArea( // so it doesn collide the notification-bar, etc..
  ...
  getData() async {
    ...
    Provider.of<MyProvider>(context, listen: false).setHomeData(data);
    // end loading
    setState(() {
      loading = false;
    });
  ...
  // gets user-data like user's cart and wishlist
  getCart() async {
        Map body = {
