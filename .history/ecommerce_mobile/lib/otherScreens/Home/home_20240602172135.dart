...
class _HomeScreenState extends State<HomeScreen> {
  ...
  getData() async {
    ...
    context.read<MyProvider>().setHomeScreenCarouselImages(data["carousel images"]);
    context.read<MyProvider>().setHomeScreenFeaturedContainer(data["images and products"]);
