            ...
            title: Row(
              children: [
                ...
                Align(
                  ...
                  child: badges.Badge(
                    badgeContent: Text("h - ${context.watch<MyProvider>().cart?.length}"),  // using .watch() so that it listens for changes
                    // ? is used for null-safety, this expression wont continue if "cart" is null, dont donfuse, its not tht complicated
                    child: IconButton(
                      onPressed: (){
                        print(context.read<MyProvider>().cart.length);
                      },
