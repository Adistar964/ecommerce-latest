...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
      if(loading || Provider.of<MyProvider>(context).dataLoaded == false){ // Provider.of method is a secure method to call inside build method
        // loading will appear until the data has been loaded form backend
