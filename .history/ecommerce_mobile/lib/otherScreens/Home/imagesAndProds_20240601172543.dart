...
class FeaturedProductsContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final homeData = Provider.of<MyProvider>(context,listen:false).homeData;

    return Consumer<MyProvider>( // wrapping anything in consumer make refresh it if any values from the provider changes
      builder: (_,provider,__) =>
      Column(
        children:
          provider.homeData["images and products"].map<Widget>( (featuredProductThings) =>
              FeaturedProducts(
