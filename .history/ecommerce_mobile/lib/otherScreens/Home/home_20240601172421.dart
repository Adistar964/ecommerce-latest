...
class _HomeScreenState extends State<HomeScreen> {
  ...
  mainBody() {
      return Scaffold(
          ...
          title: const Row(
            children: [
              ...
              Align(
                ...
                child: Icon(Icons.document_scanner_outlined, size: 27)
              )
            ]
          ) ,
          leading: IconButton(
        ...
        // app body
        body: SingleChildScrollView( // so that the whole screen is scrollable
          child: Column(
            children: [
              ...
              const SizedBox(height: 20), // leaving some space
              Consumer<MyProvider>(builder:(_,provider,__)=> const FeaturedProductsContainer()), // wrapping anything in consumer make refresh it if any values from the provider changes
            ]
          ),
        ),
      );
