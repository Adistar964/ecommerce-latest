...
class _MainWrapperScreenState extends State<MainWrapperScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: Provider.of<MyProvider>(context).dataLoaded ? // only start showing this bottomNavBar when data has been loaded from the backend, otherwise we dont want this BottomNavBar with loading screen
      BottomNavigationBar( 
