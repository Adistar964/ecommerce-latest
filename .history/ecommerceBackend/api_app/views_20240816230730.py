...
def getFilterValues(request, search_text):
    ...
    maxPrice = products_collection.find( {}, {"_id":0, "price":1,"discountPrice":1} ).sort({"price":-1}).limit(1)
    ...
    # maxPrice = maxPrice[0]["price"] - maxPrice[0]["discountPrice"] # for the actual price 
    ...
    return Response({"maxPrice":list(maxPrice),"brands":brands,"categories":categories}) 
