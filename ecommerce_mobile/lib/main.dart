...
class MyAppBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp.router( // basically MaterialApp, but we can give it our custom goRouter for routing
      ...
      theme: ThemeData( fontFamily: "Poppins" ), // now whole app by default uses "Poppins font" (We added that font manually)
      debugShowCheckedModeBanner: false, // optional => hides that debug-mode sticker/wrapper
      ...
      // but now we will use goRouter which is again much more useful for complex scenarios like deeplinking.state-preservance and persistent bottomNavBar
