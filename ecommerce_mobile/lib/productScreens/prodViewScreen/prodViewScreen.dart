...
import 'package:ecommerce_mobile/helper_components/alert.dart';
              ...
              Stack(
                children:[
                  ...
                  Positioned(
                    top: 30,
                    right: 10,
                    child: FavButton( product:product, isFav:product['isFavourite']) // this is from sliderTopButtons.dart
                  ),
        ...
        child: Container(
          ...
          child: ( product["quantityInCart"]==0? // if the product id not there in the cart
              ...
              onPressed: ()async{
                ...
                setState((){}); // to update this screen as the cart-quantity changed
              },
            ...
            : Row( // otherwise show these buttons
              ...
              Expanded(
                child: MaterialButton(
                  onPressed: ()async{
                    await subtractQuantity(context, product);
                    setState((){}); // to update this screen as the cart-quantity changed
                    },
              ...
              Expanded(
                child: MaterialButton(
                  onPressed: ()async{
                    await addQuantity(context, product, maxQuantityReachedCallback: toast(context,"Max Quantity reached!"));
                    setState((){}); // to update this screen as the cart-quantity changed
                    },
                  padding: const EdgeInsets.all(12.6),
                  color : Colors.lightBlue,
